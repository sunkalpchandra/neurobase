...
/**
 * NeuroBase's controlled vocabulary: the technology categories and medical indications
 * the product filters and facets by.
 *
 * This is reference data, not ingested data. The names are the field's own terms, and
 * they are authored here so that facets stay stable and comparable across sources —
 * registries spell the same condition a dozen ways. `synonyms` carries the spellings
 * seen in ClinicalTrials.gov and the literature, which is how an ingested record's
 * condition resolves onto a category.
 */
...
export interface ConditionDef {
  ...
  unmetNeed: boolean;
  /** Spellings seen in registries and the literature, matched case-insensitively. */
  synonyms?: string[];
}
...
export const CONDITION_DEFS: readonly ConditionDef[] = [
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Parkinson Disease", "Parkinson's Disease", "Parkinsons Disease"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Essential Tremor", "Tremor"],
  ...
  },
  {
    ...
    unmetNeed: true,
    synonyms: ["Macular Degeneration", "Age-Related Macular Degeneration", "Geographic Atrophy"],
  ...
  },
  {
    ...
    unmetNeed: true,
    synonyms: ["Locked-In Syndrome", "Locked in Syndrome", "Anarthria"],
    description:
  ...
  },
  {
    ...
    phrase: "tetraplegia",
    unmetNeed: true,
    synonyms: ["Tetraplegia", "Quadriplegia", "Cervical Spinal Cord Injury"],
  ...
  },
  {
    ...
    unmetNeed: true,
    synonyms: ["Obsessive-Compulsive Disorder", "OCD", "Obsessive Compulsive Disorder"],
    description:
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Migraine", "Migraine Disorders", "Chronic Migraine", "Headache"],
  ...
  },
  {
    ...
    phrase: "obesity",
    unmetNeed: false,
    synonyms: ["Obesity", "Obesity, Morbid", "Overweight"],
    description:
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Overactive Bladder", "Urinary Incontinence", "Urinary Urge Incontinence"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Obstructive Sleep Apnea", "Sleep Apnea, Obstructive", "Sleep Apnea Syndromes"],
    description:
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Dystonia", "Cervical Dystonia", "Dystonic Disorders", "Torticollis"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Post-Traumatic Stress Disorder", "PTSD", "Stress Disorders, Post-Traumatic"],
    description:
  ...
  },
  {
    ...
    unmetNeed: true,
    synonyms: ["Alzheimer Disease", "Alzheimer's Disease", "Dementia", "Mild Cognitive Impairment"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Traumatic Brain Injury", "Brain Injuries, Traumatic", "Brain Injury", "Concussion"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Multiple Sclerosis", "Sclerosis, Multiple"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Amputation", "Limb Loss", "Upper Limb Amputation", "Amputees"],
  ...
  },
  {
    ...
    unmetNeed: false,
    synonyms: ["Phantom Limb Pain", "Phantom Limb"],
  ...
  },
  {
    ...
    unmetNeed: true,
    synonyms: ["Brain Stem Infarctions", "Brainstem Stroke", "Pontine Infarction"],
    description:
